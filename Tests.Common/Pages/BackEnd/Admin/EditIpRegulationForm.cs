...
{
    public class EditIpRegulationForm : BackendPageBase
    {
        public EditIpRegulationForm(IWebDriver driver) : base(driver) { }

        public ViewIpRegulationForm Edit(IpRegulationData data)
        {
