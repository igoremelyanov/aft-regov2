...
{
    public class AdminUpdated : DomainEventBase
    {
        public AdminUpdated() { } // default constructor is required for publishing event to MQ

        public AdminUpdated(Admin admin)
        {
            Id = admin.Id;
