...
namespace FakeUGS.Core.Bus
{
    public class FakeUgsServiceBus : IUgsServiceBus
    {
        ...
        public FakeUgsServiceBus(ILog logger, ISynchronizationService syncService,
        ...
        public void Subscribe<TSubscriber>(Func<TSubscriber> subscriberFactory) where TSubscriber : IBusSubscriber
        {
            ...
            EnsureSubscriptionExists(TopicName, subscriberType);
        ...
        private void MessageReceivingException(object sender, ExceptionReceivedEventArgs e)
        {
            if (e.Exception != null)
            {
                _logger.Error("FakeUgsSubscriptionClient raised an exception", e.Exception);
            }
        }
