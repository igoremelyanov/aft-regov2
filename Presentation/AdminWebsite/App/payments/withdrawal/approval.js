define(['nav', "i18next", "EntityFormUtil", "payments/withdrawal/helper"], function (nav, i18n, efu, helper) {
    ...
    function ViewModel() {
        ...
        this.verifiedDate = ko.observable();
        ...
        this.revertedBy = ko.observable();
        this.revertedTime = ko.observable();
        this.acceptedBy = ko.observable();
        this.acceptedTime = ko.observable();
        ...
        efu.publishIds(this, "withdrawal-approval-", ["remarks"], "-" + vmSerial);
    ...
    ViewModel.prototype.loadWithdrawal = function (id, deferred) {
        ...
        $.ajax('/offlineWithdraw/get?id=' + id).done(function (response) {
            ...
            self.verifiedDate(withdrawal.verified);
            self.revertedBy(withdrawal.revertedBy);
            self.revertedTime(withdrawal.revertedTime);
            self.acceptedBy(withdrawal.acceptedBy);
            self.acceptedTime(withdrawal.acceptedTime);
    ...
    var naming = {
        gridBodyId: "withdrawal-approval-list"
    };
