define(['nav', "i18next", "EntityFormUtil", "payments/withdrawal/helper"], function (nav, i18n, efu, helper) {
    ...
    function ViewModel() {
        ...
        this.verifiedTime = ko.observable();
        ...
        efu.publishIds(this, "withdrawal-verification-", ["remarks"], "-" + vmSerial);
    ...
    ViewModel.prototype.loadWithdrawal = function (id, deferred) {
        ...
        $.ajax('/offlineWithdraw/get?id=' + id).done(function (response) {
            ...
            self.verifiedTime(withdrawal.verified);
    ...
    var naming = {
        gridBodyId: "withdrawal-request-list",
        editUrl: "offlineWithdraw/request"
    };
