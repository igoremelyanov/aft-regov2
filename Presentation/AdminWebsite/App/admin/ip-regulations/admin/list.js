  ...
  define(function(require) {
    ...
    ViewModel = (function(_super) {
      ...
      function ViewModel() {
        ...
        this.isAddAllowed = ko.observable(security.isOperationAllowed(security.permissions.create, security.categories.backendIpRegulationManager));
        this.isEditAllowed = ko.observable(security.isOperationAllowed(security.permissions.update, security.categories.backendIpRegulationManager));
