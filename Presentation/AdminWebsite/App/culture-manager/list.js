...
(function() {
  ...
  define(function(require) {
    ...
    return LanguageListViewModel = (function(_super) {
      __extends(LanguageListViewModel, _super);

      function LanguageListViewModel() {
        this.rowChange = __bind(this.rowChange, this);
        var isActive;
        ...
        this.isAddAllowed = ko.observable(security.isOperationAllowed(security.permissions.create, security.categories.languageManager));
        this.isEditAllowed = ko.observable(security.isOperationAllowed(security.permissions.update, security.categories.languageManager));
