      ...
      admin: {
        ...
        submenu: {
          ...
          idDocumentsSettings: {
            ...
            security: [["IdentificationDocumentSettings/View"]],
            container: [
              {
                title: "Identification Document Settings",
      ...
      playerManager: {
        ...
        submenu: {
          ...
          paymentLevelSettings: {
            ...
            security: [["PaymentLevelSettings/View"]],
            container: [
              {
                title: i18n.t("app:playerManager.paymentLevelSettings.title"),
      ...
      payment: {
        ...
        submenu: {
          ...
          playerDepositVerify: {
            ...
            security: [["DepositVerification/View"]],
            container: [
              {
                title: i18n.t("app:sidebar.playerDepositVerify"),
          ...
          paymentGatewaySettings: {
            ...
            security: [["PaymentGatewaySettings/View"]],
            container: [
              {
                title: i18n.t("app:payment.paymentGatewaySettings"),
      ...
      report: {
        ...
        submenu: {
          ...
          brandReports: {
            ...
            security: [["BrandReport/View"], ["LicenseeReport/View"], ["VipLevelReport/View"]],
            container: [
              {
                title: i18n.t("app:report.brandReports.title"),
                path: "reports/list",
      ...
      brand: {
        ...
        submenu: {
          ...
          supportedCurrencies: {
            ...
            security: [["SupportedCurrencies/View"]],
            container: [
              {
                title: i18n.t("app:currencies.supportedCurrencies"),
