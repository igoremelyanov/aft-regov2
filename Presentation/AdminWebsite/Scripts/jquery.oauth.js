define(['config'], function (config) {
    ...
    jqOAuth.prototype.getTokenName = function getTokenName() {
        return this.options.tokenName;

    };

    jqOAuth.prototype.hasToken = function hasToken() {
        return this.data.accessToken !== null && this.data.refreshToken !== null;
    };
    ...
    jqOAuth.prototype.setToken = function setToken(accessToken, refreshToken) {
    ...
    jqOAuth.prototype._resetOptions = function _resetOptions() {
        this.options = {
            ...
            csrfToken: null,
            events: {},
            tokenName: 'jquery.oauth.' + config.adminApiClientId
        };
